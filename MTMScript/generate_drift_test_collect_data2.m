...
[start_joint_pos_mat(:,:,end+1),end_joint_pos_mat(:,:,end+1),SLSE1POL_pose_mat_cell_list]  = gravity_compensation_test(test_pos_mat,config);
...
save('./data/drift_test/drift_test_CAD_SLSE1POL_MLSE4POL','CAD_pose_mat_cell_list','SLSE1POL_pose_mat_cell_list','MLSE_4POL_pose_mat_cell_list','start_joint_pos_mat','end_joint_pos_mat');
