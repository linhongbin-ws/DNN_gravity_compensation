function Torques_data = get_torque_data(test_dataCollection_info_str)
...
function [dynamic_parameters_vec, Torques_pos_data, Torques_neg_data] = lse_mtm_one_joint(config_lse_joint, previous_config)
    ...
    if ~exist('previous_config')
        [dynamic_parameters_vec, Torques_pos_data, Torques_neg_data] = lse_model(config_lse_joint);
    else
